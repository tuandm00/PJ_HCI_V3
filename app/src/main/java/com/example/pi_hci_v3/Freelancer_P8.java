    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnQuaylai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Freelancer_P8.this, Freelancer_P7.class);
        ...
        btnTrangchu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Freelancer_P8.this, FreelancerMainActivity.class);
                startActivity(intent);
            }
        });
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Freelancer_P8.this,SearchActivity.class);
                startActivity(intent);
            }
        });
        ...
        imgSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Freelancer_P8.this,Freelancer_P8.class);
                startActivity(intent);
            }
        });
