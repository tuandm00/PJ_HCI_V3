...
public class Freelancer_P6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Freelancer_P6.this,SearchActivity.class);
                startActivity(intent);
            }
        });
        ...
        imgSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Freelancer_P6.this,Freelancer_P8.class);
                startActivity(intent);
            }
        });
        ...
        imgProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Freelancer_P6.this,Freelancer_P7.class);
                startActivity(intent);
            }
        });
    }
