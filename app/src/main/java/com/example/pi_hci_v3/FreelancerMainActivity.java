        ...
        nav.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.back:
                        Toast.makeText(FreelancerMainActivity.this,"Trang Chủ", Toast.LENGTH_SHORT);
                        Intent intent1 = new Intent(FreelancerMainActivity.this, FreelancerMainActivity.class);
                        startActivity(intent1);
                        break;
                    case R.id.search:
                        Toast.makeText(FreelancerMainActivity.this,"Tìm kiếm", Toast.LENGTH_SHORT).show();
                        Intent intent2 = new Intent(FreelancerMainActivity.this, SearchActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.save:
                        Toast.makeText(FreelancerMainActivity.this,"Lưu", Toast.LENGTH_SHORT).show();
                        Intent intent3 = new Intent(FreelancerMainActivity.this, Freelancer_P8.class);
                        startActivity(intent3);
                        break;
                    case R.id.profile:
                        Toast.makeText(FreelancerMainActivity.this,"Trang Cá Nhân", Toast.LENGTH_SHORT).show();
                        Intent intent4 = new Intent(FreelancerMainActivity.this, ProfileUser.class);
